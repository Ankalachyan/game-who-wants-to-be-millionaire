...
(78, 78, 'Անդրոմեդա Գալակտիկա', 'Ծիր Կաթին Գալակտիկա', 'Եռանկյունի Գալակտիկա', 'Սոմբրերո Գալակտիկա', 2),
...
(85, 85, 'Պրոքսիմա Կենտավրոս', 'Սիրիուս', 'Բետելգեյզ', 'Կենտավրոսի Ալֆա', 1),
(86, 86, 'Միջուկային տրոհում', 'Միջուկային միաձուլում', 'Միջուկային քայքայում', 'Միջուկային փոխակերպում', 2),
(87, 87, 'Սիրիուս', 'Բևեռաս', 'Վեգա', 'Կենտավրոսի Ալֆա', 1),
...
(91, 91, '3', '4', '5', '6', 2),
(92, 92, 'Արարատ', 'Էվերեստ', 'Քարաքորամ լեռ', 'Կանգչենջունգա', 2),
(93, 93, 'Նիագարա', 'Անխել', 'Վիկտորիա', 'Իգուասու', 2),
...
(106, 106, 'Հիպոպոտամուս', 'Կոկորդիլոս', 'Բեգեմոտ', 'Ծովացուլ', 1),
(107, 107, 'Rockhopper պինգվին', 'Փոքրիկ կապույտ պինգվին', 'Մակարոնի պինգվին', 'Կայսերական պինգվին', 4),
(108, 108, 'Փիղ', 'Կապույտ կետ', 'Կիթիի խոզաքիթ չղջիկ', 'Ընձուղտ', 3),
(109, 109, 'Սպիտակ արջ', 'Գորիլա', 'Հիպոպոտամուս', 'Զեբրա', 1),
(110, 110, 'Մեծ սպիտակ շնաձուկ', 'Հսկայական շնաձուկ-մուրճ', 'Կետային շնաձուկ', 'Վագրային շնաձուկ', 3),
...
(134, 134, '20π քառակուսի միավոր', '25π քառակուսի միավոր', '31,4π քառակուսի միավոր', '900π քառակուսի միավոր', 2),
(135, 135, '2.71828', '3.71828', '2.71802', '2.71817', 1),
(136, 136, 'Անգելա Մերկել', 'Գերհարդ Շրյոդեր', 'Կոնրադ Ադենաուեր', 'Հելմուտ Կոլ', 1),
(137, 137, 'Թերեզա Մեյ', 'Մարգարետ Թետչեր', 'Լորդեսա Աստոր', 'Հարոլդ Վիլսոն', 2),
...
(141, 141, 'Բարաք Օբամա', 'Ջորջ Հ. Ու. Բուշ', 'Դոնալդ Թրամփ', 'Բիլ Քլինթոն', 1),
(142, 142, 'F. W. de Klerk', 'Տաբո Մբեկի', 'Կիրիլ Ռամաֆոզա', 'Նելսոն Մանդելա', 4),
(143, 143, 'Նուրսուլթան Նազարբաև', 'Կասիմ-Ժոմարտ Տոկաև', 'Քենեսարի Կասիմով', 'Ասկար Ախմետով', 1),
(144, 144, 'Սեբաստիան Կուրց', 'Ալեքսանդր Վան դել Բելեն', 'Քրիստիան Կեռն', 'Կարլ Նեհամեր', 4),
(145, 145, 'Միշել Թեմեր', 'Ժաիր Բոլսոնարու', 'Դիլմա Ռուսեֆ', 'Լուիս Ինասիու Լուլա դա Սիլվա', 4),
(146, 146, 'Ռո Մու-Հյուն', 'Տաևու Ռո', 'Կիմ Ջե Ջունգ', 'Լի Սին Ման', 4),
...
(149, 149, 'Քրիստինա Ֆեռնանդես դե Կիրշներ', 'Մարիա Էվելինա դե Կիրշներ', 'Իսաբել Մարտինես դե Պերոն', 'Կամիլա Վալդիվիա', 3),
(150, 150, 'Մեգավատի Սուկարնոպուտրի', 'Սուսիլո Բամբանգ Յուդոյոնո', 'Աբդուլլահ Ահմադ Բադավի', 'Ջոկո Վիդոդո', 1),
(151, 151, 'Թոմ Հենքս', 'Բրեդ Փիթ', 'Լեոնարդո ԴիԿապրիո', 'Ջոնի Դեփ', 1),
...
(155, 155, 'Բրեդ Փիթ', 'Թոմ Քրուզ', 'Լեոնարդո ԴիԿապրիո', 'Ռոբերտ Դաունի կրտսերը', 3),
(156, 156, "Led Zeppelin", "AC/DC", "Guns N' Roses", "The Rolling Stones", 1),
(157, 157, '«Parasite»', '«Green Book»', '«Once Upon a Time...in Hollywood»', '«12 Years a Slave»', 1),
(158, 158, 'Քիթ Հարինգթոն', 'Էմիլիա Քլարկ', 'Փիթեր Դինքլեյջ', 'Բոլոր թվարկված դերասանները', 4),
(159, 159, '«Star Wars: Episode VIII - The Last Jedi»', '«Spider-man Far From Home»', '«Parasite»', '«Green Book»', 4),
...
(170, 170, 'Ֆրենսիս Ֆորդ Կոպպոլա', 'Մարտին Սկորսեզե', 'Սթենլի Կուբրիկ', 'Ալֆրեդ Հիչքոք', 1),
(171, 171, 'Քրիս Կոլումբուս', 'Ալֆոնսո Կուարոն', 'Դեյվիդ Եյթս', 'Վերը նշված բոլորը', 4),
(172, 172, 'Ռոբերտ Դաունի կրտսեր', 'Քրիս Էվանս', 'Թոմ Հոլանդ', 'Քրիս Հեմսվորթ', 1),
(173, 173, 'Մարկ Հեմիլ', 'Հարիսոն Ֆորդ', 'Քերրի Ֆիշեր', 'Ալեք Գինես', 1),
(174, 174, 'Բազ Լույսի Տարի', 'Միստր Կարտոֆիլ', 'Գլուխ Համ', 'Սլինկի շուն', 4),
(175, 175, '«Toy Story»', '«The Lion King (1994)»', '«Finding Nemo»', '«Shrek»', 2),
(176, 176, 'Քվենտին Տարանտինո', 'Մարտին Սկորսեզե', 'Սթիվեն Սփիլբերգ', 'Քրիստոֆեր Նոլան', 1),
(177, 177, 'Ռոբերտ դե Նիրո', 'Ալ Պաչինո', 'Ջեք Նիքոլսոն', 'Դասթին Հոֆման', 1),
(178, 178, '«Avengers 4. Endgame»', '«Titanic»', '«Avatar»', '«Star Wars: The Force Awakens»', 3),
...
(81, 'Ո՞ր մոլորակն է հայտնի իր օղակների համակարգով:', 'Astronomy', 2),
...
(92, 'Ո՞րն է Երկիր մոլորակի ամենաբարձր գագաթը, հաշված ծովի մակարդակից:', 'Geography', 1),
...
(103, 'Ո՞ր երկիրն է հայտնի որպես «Կրակի և սառույցի երկիր»:', 'Geography', 4),
(104, 'Ո՞ր մայրցամաքում է գտնվում Ամազոնի անձրևային անտառը:', 'Geography', 4),
...
(112, 'Թվարկվածներից որն է պատասխանատու Աֆրիկայում մարդկանց մահվան մեծ մասի համար:', 'Animals', 3),
(113, 'Ո՞ր կենդանին է աշխարհում միակ թունավոր պրիմատը:', 'Animals', 3),
(114, 'Ո՞ր կենդանին է հաղորդակցվում ինֆրաձայնի միջոցով:', 'Animals', 3),
...
(120, 'Հետևյալ կենդանիներից ո՞րն է հայտնի քողարկվելու և գույնը փոխելու ունակությամբ:', 'Animals', 3),
(121, 'Առավելագույնը քանի՞ ուղիղ անկյուն կարող է ունենալ քառանկյունը:', 'Math', 1),
(122, 'Քանի՞ աստիճան է եռանկյան անկյունը եթե մյուս անկյուններն են 50 և 100:', 'Math', 2),
(123, 'Ո՞վ է համարվում «երկրաչափության հայրը»:', 'Math', 2),
...
(129, 'Լուծե՛ք հավասարումը 3x + 7 = 22', 'Math', 2),
...
(137, 'Ո՞վ է եղել Բրիտանիայի առաջին կին վարչապետը:', 'Politics', 1),
...
(164, 'Հետևյալ դերասաններից ո՞վ է խաղացել «The Shawshank Redemption» ֆիլմում:', 'Pop-culture', 5),
(165, 'Հետևյալ ռեժիսորներից ո՞վ է նկարահանել «Interstellar» ֆիլմը:', 'Pop-culture', 5),
(166, 'Ո՞ր Հոգվարթսի թիմին է պատկանում Դրակո Մալֆոյը:', 'Media', 1),
(167, 'Ո՞ր դերասանն է մարմնավորել Նեոյի կերպարը «The Matrix» եռերգության մեջ:', 'Media', 1),
(168, 'Ո՞ր անիմացիոն ֆիլմում են Էլզան և Աննան:', 'Media', 1),
(169, 'Ո՞վ է նկարահանել «The Shawshank Redemption» ֆիլմը:', 'Media', 2),
(170, 'Ո՞վ է նկարահանել «The Godfather» ֆիլմը:', 'Media', 2),
(171, 'Ո՞վ է բեմադրել Հարի Փոթերի ֆիլմաշարը:', 'Media', 2),
(172, 'Ո՞ր դերասանն է խաղացել Թոնի Ստարկի/Երկաթե մարդու դերը «Marvel Cinematic Universe»-ում:', 'Media', 3),
(173, 'Ո՞վ է խաղացել Լյուք Սքայուոքերի կերպարը բնօրինակ «Star Wars» եռագրության մեջ:', 'Media', 3),
(174, '«Toy Story» ֆիլմում ինչպե՞ս է կոչվում Վուդիի հավատարիմ օգնականը:', 'Media', 3),
...
(177, 'Ո՞վ է խաղացել գլխավոր դերը 1976թ-ին նկարահանված «Taxi Driver» ֆիլմում :', 'Media', 4),
